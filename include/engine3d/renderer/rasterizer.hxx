...
public:
    ...
    void draw_line(vector2 p0, vector2 p1, graphics::colour c);
    void draw_triangle(vector2 p0, vector2 p1, vector2 p2, graphics::colour c);
    void draw_filled_triangle(vector2 p0, vector2 p1, vector2 p2, graphics::colour c);
